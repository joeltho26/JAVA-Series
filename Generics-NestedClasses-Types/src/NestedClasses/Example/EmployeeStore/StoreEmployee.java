package NestedClasses.Example.EmployeeStore;
...
public class StoreEmployee extends Employee {
    ...
    public StoreEmployee(String name, int yearStarted) {
        this(name, yearStarted,"Costco");
    }

    public StoreEmployee(String name, int yearStarted, String store) {
