...
public class BankAccount {
    ...
    public BankAccount () {
        this(BankAccount.number++,0.0,"HOME","bank@gmail.com","123456789");
    }

    public BankAccount (String name, String email, String contact) {
        this(BankAccount.number++,500,name,email,contact);
    }

    public BankAccount (int accountNumber, double accountBalance, String name, String email, String contact) {
